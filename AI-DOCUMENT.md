...
-   ~~đã thuyết trình~~ **AI vs ML vs DL:** Sự khác biệt cơ bản giữa Trí tuệ nhân tạo (AI), Học máy (Machine Learning) và Học sâu (Deep
...
-   ~~đã thuyết trình~~ **Model Landscape:** Sự khác biệt về thế mạnh giữa các dòng mô hình chủ đạo (OpenAI GPT, Anthropic Claude, Google
...
-   ~~đã thuyết trình~~ **Multimodality (Đa phương thức):** AI đa phương thức là gì? Việc AI có thể "nhìn" (Vision), "nghe" (Audio) và "nói"
...
-   ~~đã thuyết trình~~ **Next Token Prediction:** Cơ chế "Dự đoán Token tiếp theo" hoạt động như thế nào và tại sao nói AI là một "cỗ máy
    xác suất"?
...
-   ~~đã thuyết trình~~ **Fluency vs. Factuality:** Tại sao các mô hình AI thường ưu tiên độ mượt mà (Fluency) hơn tính chính xác
